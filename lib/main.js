...
function displayPayResult(payResult) {
	if (_.isNumber(payResult)) {
		...
		return console.log(`just ${dispenser.currentSnack.price - dispenser.balance}p more to pay for that delicious ${dispenser.currentSnack.id}`);
	}
