...
function displayStats() {
	console.log(`Currently paying for ${dispenser.currentSnack? dispenser.currentSnack.id : 'nothing'}. The current balance is ${dispenser.balance}.`);
	console.log(`The machine contains the following snacks: ${JSON.stringify(repository.snacks)}.`);
	console.log(`The machine contains the following coins: ${JSON.stringify(changeCalculator.coins)}.`);
}
