...
function restock(parts) {
	...
	console.log(`Machine now contains the following snacks: ${JSON.stringify(repository.snacks)}`);
}
...
function loadCoins(parts) {
	...
	console.log(`The machine now contains the following coins: ${JSON.stringify(changeCalculator.coins)}`);
}
